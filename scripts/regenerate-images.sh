...
stack exec waterfall-cad-examples --  --text --content "Waterfall CAD" --dark-mode-svg images/text.svg --font images/fonts/nunito/Nunito-Black.ttf
...
stack exec waterfall-cad-examples --  --text --content "Waterfall CAD" --glb images/models/text.glb --font images/fonts/nunito/Nunito-Black.ttf --resolution 0.01
